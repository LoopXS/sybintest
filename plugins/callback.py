            ...
            if data.startswith("sch_month"):
                ...
                if yea_r == "choose":
                    ...
                    if month == today.month and date < today.day and year==today.year+1:
                        ...
                        pyear=year
                    button.append([InlineKeyboardButton("✗ ʙᴀᴄᴋ ✗", callback_data=f"sch_showdate_{pyear}_{month}"), InlineKeyboardButton("✗ ᴄʟᴏꜱᴇ ✗", callback_data="schclose")])
                ...
                for i in range(0, len(l), 6):
                    ...
                    button.append(k)
                button.append([InlineKeyboardButton("✗ ʙᴀᴄᴋ ✗", callback_data=f"sch_month_{year}_{month}_{day}"), InlineKeyboardButton("✗ ᴄʟᴏꜱᴇ ✗", callback_data="schclose")])
